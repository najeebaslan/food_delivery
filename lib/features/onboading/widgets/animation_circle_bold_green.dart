...
class HeaderAnimationCircleGreen extends StatelessWidget {
  const HeaderAnimationCircleGreen({
    super.key,
            ...
            return AnimatedPositioned(
              ...
              child: Transform(
                ...
                child: onboardingCubit.completedFirstAnimation == false
                    ? AnimationCircleGreenFirst(
                        onboardingHeroTags: onboardingHeroTags,
                        onboardingCubit: onboardingCubit,
                      )
                    : AnimationCircleGreenLast(
                        onboardingHeroTags: onboardingHeroTags,
                        onboardingCubit: onboardingCubit,
                      ),
              ),
...
class AnimationCircleGreenFirst extends StatelessWidget {
  const AnimationCircleGreenFirst({
    super.key,
    required this.onboardingHeroTags,
    required this.onboardingCubit,
  });
...
class AnimationCircleGreenLast extends StatelessWidget {
  const AnimationCircleGreenLast({
    super.key,
    required this.onboardingHeroTags,
    required this.onboardingCubit,
  });
                  ...
                  return Transform.rotate(
                    ...
                    child: SvgPicture.string(
                      ...
                      colorFilter: ColorFilter.mode(
                        onboardingCubit.colorCircleRedFirst(AppColors.green),
                        BlendMode.srcIn,
                      ),
                    ),
                  );
