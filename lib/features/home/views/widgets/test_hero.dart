...
class RadialExpansionDemo extends StatelessWidget {
  ...
  static Interval opacityCurve = const Interval(0.55, 0.55, curve: Curves.easeInCirc);
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Row(
          ...
          children: [
            _buildHero(context, ImagesConstants.friesFront, 'Chair'),
            _buildHero(context, ImagesConstants.colaIsometric, 'Binoculars'),
            _buildHero(context, ImagesConstants.mayoIsometric, 'Beach ball'),
          ],
        ),
      ),
    );
